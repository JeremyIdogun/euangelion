...
const ADMIN_COOKIE_NAME = 'besorah_admin_session';
const LEGACY_ADMIN_COOKIE_NAME = 'euangelion_admin_session';
...
function buildClearAdminCookie(req, cookieName = ADMIN_COOKIE_NAME) {
  const parts = [
    `${cookieName}=`,
    'Path=/',
    'HttpOnly',
...
export function clearAdminSessionCookie(req, res) {
  res.setHeader('Set-Cookie', [
    buildClearAdminCookie(req, ADMIN_COOKIE_NAME),
    buildClearAdminCookie(req, LEGACY_ADMIN_COOKIE_NAME),
  ]);
}
